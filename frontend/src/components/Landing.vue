<template>
    <div class="font-sans">
        <div class="banner px-16 relative flex flex-col justify-center items-center sm:px-0 sm:justify-between sm:flex-row">
            ...
            <div class="sm:h-full sm:flex sm:flex-1 flex-col items-center justify-center">
                <h1 class="text-5xl text-justify font-extrabold leading-170">THINK. BUILD. SHIP.</h1>
                <p class="text-xl text-justify pt-14 sm:w-4/7 leading-160 opacity-60"> Commodo aute aliquip excepteur incididunt ut magna minim esse sit elit. Aute mollit veniam laborum reprehenderit tempor est aute enim. Proident deserunt laborum reprehenderit ut.</p>
            </div>
            <div class="w-88 sm:flex sm:h-full items-center justify-center">
                <img class="hidden sm:block w-full pt-20" src="@/assets/images/home2.png" />
