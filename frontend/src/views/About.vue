<template>
    <div class="flex flex-col sm:pt-60 pt-48 w-full overflow-x-hidden">
        <full-page :options="options" id="fullpage" ref="fullpage">
            <div
                class="section flex flex-col-reverse sm:flex-row-reverse items-center justify-between sm:justify-between flex-col pl-0 pr-0"
            >
                <div
                ...
                >
                    ...
                    >
                        SDSLabs or Software Development Section Laboratories is
                        a student-run technical group at IIT Roorkee, which aims
                        to encourage the development of technology and
                        innovation in the campus and beyond. We believe in
                        learning and sharing knowledge; collaboration and
                        experimentation; and human interaction that matters the
                        most.
                    </div>
                </div>
            </div>
            <div
                class="section flex flex-col-reverse mt-36 sm:flex-row sm:justify-between sm:ml-64 sm:mr-36 sm:pt-36"
            >
                <div class="mt-16 sm:mt-0 ml-8 mr-8"><Gallery /></div>
                <div
                    class="flex flex-col mr-8 ml-8 sm:w-auto sm:ml-100 sm:pt-8"
                >
                    ...
                    >
                        We are involved in a lot of activities on the campus,
                        off the campus and on the web. We conduct lectures and
                        workshops on different fields of tech, organize
                        hackathons, and also conduct online competitions on our
                        various self developed applications.
                    </div>
                </div>
            </div>
            <div class="section flex flex-col mt-32 sm:mt-100 w-full">
                    ...
                    >
                        ...
                        <div class="flex flex-col sm:pl-60 mx-10">
                            ...
                            <div
                                class="sm:w-180 pt-10 text-1.5xl sm:text-lg sm:font-medium text-grey leading-170"
                            >
                                We constantly explore and experiment, try to
                                learn new things, and get out of the comfort
                                zones. This gives the members of SDSLabs a
                                freedom to work in a diverse range of fields in
                                technology and innovation, some of which are
                                mentioned here.
                            </div>
                        </div>
                    </div>
            ...
            <div class="section">
                <div
                    class="timeline flex flex-col sm:items-center sm:mt-92 mt-36"
                >
                    <div
                    ...
                    >
                        ...
                        >
                            ...
                            proud of and the milestones that we were able to
                            achieve as a group over the course of time.
                        </div>
                    </div>
